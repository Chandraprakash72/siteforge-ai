  ...
  return (
    <div className="relative min-h-screen bg-[#040404] text-white overflow-hidden">
                ...
                <AnimatePresence>
                  {openProfile && (
                    ...
                    >
                      ...
                      <button
                        className="w-full px-4 py-4 text-left text-sm hover:bg-white/5"
                        onClick={() =>
                          navigate("/dashboard")
                        }
                      >
                      ...
                      <button
                        className="w-full px-4 py-4 text-left text-sm text-red-400 hover:bg-white/5"
            ...
            {highlights.map((h, i) => (
              ...
              >
                ...
                <p className="text-sm text-zinc-400">
                  SiteForge.ai builds real websites with
                  clean code, animations, responsiveness,
      ...
      <footer className="border-t border-white/10 py-10 text-center text-sm text-zinc-500">
        &copy; {new Date().getFullYear()} SiteForge.ai
      </footer>
