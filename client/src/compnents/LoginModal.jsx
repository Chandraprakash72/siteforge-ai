      ...
      {open && (
        ...
        >
          ...
          >
            ...
            />
            <button
            className='absolute top-5 right-5 z-20 text-zinc-500 hover:text-white transition text-lg'
            onClick={onClose}>
                X
            </button>
...
<div className='relative flex items-center justify-center gap-3'>
  ...
  <div className ='flex items-center gap-4 my-10'>
    <div className='h-px flex-1 bg-white/10'/>
      <span className='text-xs text-zinc-5 tracking-wide'>Secure Login</span>
    <div className='h-px flex-1 bg-white/10'/>
</div>
