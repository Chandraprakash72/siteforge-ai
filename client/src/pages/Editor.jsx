...
function WebsiteEditor() {
  ...
  return (
    <div className="h-screen w-screen flex bg-black text-white overflow-hidden">
        ...
        <div className="p-3 border-t border-white/10">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-2xl px-4 py-3 bg-white/5 border border-white/10 outline-none"
      ...
      <AnimatePresence>
  {showFullPreview && (
    <motion.div className="fixed inset-0 z-[9999] bg-white">
      <iframe
      ...
      <button
        ...
        className="absolute top-4 right-4 p-2 bg-black/70 text-white rounded-lg"
      >
        <X />
      </button>
    </motion.div>
